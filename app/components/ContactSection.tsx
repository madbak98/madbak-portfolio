...
const HANDLES = {
  ...
  instagram: "@madbak98",
  telegram: "@Lilosaama",
  whatsapp: "+90 501 005 03 95",
  linkedin: "babak-ravanbakhsh",
  github: "@madbak98",
} as const;

const socialItems: {
  key: "x" | "instagram" | "telegram" | "whatsapp" | "linkedin" | "github";
